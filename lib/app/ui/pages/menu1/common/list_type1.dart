...
class Menu1ListType1 extends StatelessWidget {
  final Menu1ListType1Controller c = Get.put(Menu1ListType1Controller());

  final String type;

  Menu1ListType1({Key? key, required this.type}) : super(key: key);
